 ...
 *
 *
 * This Color Class is used as abstraction for android and JVM.
 */
...
//	}
    ...
    /**
     * Convert HSV components to an ARGB color. Alpha set to 0xFF. hsv[0] is Hue
     * [0 .. 360) hsv[1] is Saturation [0...1] hsv[2] is Value [0...1] If hsv
     * values are out of range, they are pinned.
     *
    ...
    /**
     * Convert RGB components to HSV. hsv[0] is Hue [0 .. 360) hsv[1] is
    ...
    public static int brighter(int color) {
        return Color.HSBtoColor(Color.hue(color), Color.saturation(color),
                Color.brightness(color) * 1.2f);
    }
    ...
    /**
     * Convert the argb color to its HSV components. hsv[0] is Hue [0 .. 360)
    ...
    public static int parseColor(String colorString) {
        if (colorString.charAt(0) == '#') {
            ...
            Integer color = sColorNameMap.get(colorString
