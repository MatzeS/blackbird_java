...
function(add_avr_executable EXECUTABLE_NAME)
    ...
    add_custom_target(
            upload
            ${AVR_UPLOADTOOL} -p ${AVR_MCU} -c ${AVR_PROGRAMMER} -b ${AVR_UPLOADTOOL_BAUD_RATE}
        ...
        set(UPLOAD_SCRIPT_FILE ${CMAKE_CURRENT_BINARY_DIR}/../upload.sh)

    add_custom_target(
            upload_script
            COMMAND rm -f ${UPLOAD_SCRIPT_FILE}
            COMMAND echo -n ${AVR_UPLOADTOOL}
                -p ${AVR_MCU}
                -c ${AVR_PROGRAMMER}
                -b ${AVR_UPLOADTOOL_BAUD_RATE}
                -U flash:w:src/${hex_file}
                -P >> ${UPLOAD_SCRIPT_FILE}
            COMMAND echo -n " $$" >> ${UPLOAD_SCRIPT_FILE}
            COMMAND echo -n "1" >> ${UPLOAD_SCRIPT_FILE}
            COMMAND chmod u+x ${UPLOAD_SCRIPT_FILE}
            DEPENDS ${hex_file}
            COMMENT "saved script to ${UPLOAD_SCRIPT_FILE}"
    )
